...
export default function QuizDetailClient({ initialQuiz, initialAttempts }: Props) {
  ...
  const [editData, setEditData] = useState<QuizMetadata>({
    ...
    timeLimit: initialQuiz.time_limit || null,
    tags: initialQuiz.tags || [],
    feedbackMode: initialQuiz.feedback_mode ?? null,
    backtracking: initialQuiz.backtracking ?? true,
  })
  const [editQuestions, setEditQuestions] = useState<Question[]>(initialQuiz.questions || [])
