    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none ${errors.description ? 'border-red-500' : 'border-gray-300'
            }`}
          maxLength={1000}
        />
        <div className="flex items-center justify-between mt-1">
      ...
      <div>
        ...
        <input
          ...
          min={5}
          max={180}
          className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.timeLimit ? 'border-red-500' : 'border-gray-300'
            }`}
        />
        {errors.timeLimit && (
